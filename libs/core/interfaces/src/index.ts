export * from './lib/animation-frames-config';
export * from './lib/brick-config';
export * from './lib/climp-speed';
export * from './lib/colors-config';
...
export * from './lib/sky-config';
export * from './lib/state-config';
export * from './lib/storage-config';
export * from './lib/text-message';
export * from './lib/tower-config';
export * from './lib/control-touch-event';
export * from './lib/control-action-event';
export * from './lib/types/config';
export * from './lib/types/control';
